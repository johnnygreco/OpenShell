...
For agent admission failures, verify that exactly one configured middleware has
an agent-conversation binding, uses `fail_closed`, selects one exact provider
